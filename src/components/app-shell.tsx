  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc] text-slate-950">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <MobileNav />
        <footer className="border-t border-black/[0.06] bg-white px-5 py-4 text-center text-xs text-slate-400 dark:border-white/10 dark:bg-slate-950"><div className="flex flex-wrap justify-center gap-x-4 gap-y-2"><Link href="/legal/privacy" className="hover:text-slate-700 dark:hover:text-slate-200">{t("privacy")}</Link><Link href="/legal/terms" className="hover:text-slate-700 dark:hover:text-slate-200">{t("terms")}</Link><Link href="/legal/community" className="hover:text-slate-700 dark:hover:text-slate-200">{t("community")}</Link><Link href="/legal/data-retention" className="hover:text-slate-700 dark:hover:text-slate-200">{t("dataRetention")}</Link></div></footer>
      </div>
    </div>
  );
}
