...
export async function Topbar(){
 ...
 return <header className="flex h-18 items-center justify-between border-b border-black/[0.06] bg-white/90 px-5 backdrop-blur sm:px-8">
   ...
   <div className="relative hidden w-full max-w-md md:block"><div className="flex h-10 items-center rounded-xl border border-slate-200 bg-slate-50 pl-3 text-slate-400"><SearchIcon size={17}/><span className="ml-5 text-sm">Search decks, cards, tags...</span><span className="ml-auto mr-3 text-xs text-slate-400">⌘ K</span></div></div>
