...
export function ReviewRunner({userId,card,stateData,preferences}:{userId:string;card:{id:string;content:Record<string,string>;kind:string};stateData:any;preferences:Preferences}){
