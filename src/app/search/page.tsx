...
export default async function SearchPage({searchParams}:{searchParams:Promise<SearchParams>}){
 ...
 const visibleCollections=(collections??[]).filter((collection:any)=>!workspaceId||workspaceDeckIds.length>0);
