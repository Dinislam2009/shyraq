...
export default function ExportPage(){
 ...
 <div className="mt-8 grid gap-4 sm:grid-cols-2">
  <a href="/api/export/json" className="rounded-2xl border border-black/[0.06] bg-white p-6 hover:bg-slate-50"><h2 className="font-semibold">Full backup JSON</h2><p className="mt-2 text-sm text-slate-500">Decks, cards, templates, tags, collections, review states, review history, scheduler settings, media metadata and sharing relationships.</p></a>
