...
export default async function CollaborationPage({params,searchParams}:{params:Promise<{id:string}>;searchParams?:Promise<{error?:string;saved?:string}>}){
 ...
 if(permission.deckRole==="none")return <AppShell><div className="mx-auto max-w-4xl px-5 py-10">You do not have workspace access.</div></AppShell>;
 const canEdit=permission.deckRole==="editor";
 const canComment=permission.deckRole==="commenter"||permission.deckRole==="editor";
